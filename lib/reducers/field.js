(function (global, factory) {
        ...
        return (0, _reactAddonsUpdate2['default'])(state, {
            meta: (_meta = {}, _meta[name] = {
                $apply: function $apply() {
                    var meta = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : _constants.DEFAULT_META;
        ...
        return (0, _reactAddonsUpdate2['default'])(state, {
            meta: {
                $apply: function $apply(meta) {
                    return (0, _dataPathMap.setInWithPath)(meta || _constants.DEFAULT_META, name, function (data) {
            ...
            meta: {
                $apply: function $apply(meta) {
                    return Object.keys(meta).reduce(function (nextMeta, key) {
                        ...
                        nextMeta[key] = _extends({}, _constants.DEFAULT_META, meta[key], {
    ...
    function fillMeta(state, action) {
        var _meta8;
        ...
        return (0, _reactAddonsUpdate2['default'])(state, {
            meta: (_meta8 = {}, _meta8[name] = {
                $apply: function $apply() {
                    var target = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : _constants.DEFAULT_META;

                    return _extends({}, target, meta);
                }
            }, _meta8)
        });
    }
