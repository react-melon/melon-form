(function (global, factory) {
    ...
    function arrayPush(state, action) {
        ...
        return (0, _reactAddonsUpdate2['default'])(state, {
            ...
            meta: {
                $set: _extends({}, meta, (0, _mapValues2['default'])((0, _dataPathMap.make)(elements, name, currentValue.length), function () {
    ...
    function arraySplice(state, action) {
        ...
        return (0, _reactAddonsUpdate2['default'])(state, {
            ...
            meta: {
                $set: (0, _dataPathMap.splice)(meta, name, currentValue, start, deleteCount, replacements, _constants.DEFAULT_META)
            }
        });
    }
});
