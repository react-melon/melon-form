(function (global, factory) {
    ...
    var MAP = (_MAP = {}, _MAP[actionTypes.FOCUS] = reducers.focus, _MAP[actionTypes.CHANGE] = reducers.change, _MAP[actionTypes.TOUCH] = reducers.touch, _MAP[actionTypes.TOUCH_ALL] = reducers.touchAll, _MAP[actionTypes.BLUR] = reducers.blur, _MAP[actionTypes.ARRAY_SWAP] = reducers.arraySwap, _MAP[actionTypes.ARRAY_PUSH] = reducers.arrayPush, _MAP[actionTypes.ARRAY_POP] = reducers.arrayPop, _MAP[actionTypes.ARRAY_SHIFT] = reducers.arrayShift, _MAP[actionTypes.ARRAY_UNSHIFT] = reducers.arrayUnshift, _MAP[actionTypes.ARRAY_SPLICE] = reducers.arraySplice, _MAP[actionTypes.INITIALIZE] = reducers.initialize, _MAP[actionTypes.RESET] = reducers.reset, _MAP[actionTypes.VALIDITY_UPDATE] = reducers.updateValidity, _MAP[actionTypes.ASYNC_VALIDATE_START] = reducers.setValidateStart, _MAP[actionTypes.ASYNC_VALIDATE_SUCCEED] = reducers.setValidateSucceed, _MAP[actionTypes.ASYNC_VALIDATE_FAILED] = reducers.setValidateFailed, _MAP[actionTypes.REGISTER] = reducers.register, _MAP[actionTypes.UNREGISTER] = reducers.unregister, _MAP[actionTypes.PENDING_START] = reducers.startPending, _MAP[actionTypes.PENDING_STOP] = reducers.stopPending, _MAP[actionTypes.FILL_META] = reducers.fillMeta, _MAP);
