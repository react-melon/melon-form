(function (global, factory) {
    ...
    function createField() {
        ...
        var FormField = function (_Component) {
            ...
            FormField.prototype.shouldComponentUpdate = function shouldComponentUpdate(nextProps, nextState, nextContext) {
                return !(0, _objects2['default'])(nextProps, this.props) || !(0, _objects2['default'])(this.context, nextContext);
            };
            ...
            FormField.prototype.componentWillReceiveProps = function componentWillReceiveProps(nextProps, nextContext) {

                if (this.props.name === nextProps.name && nextContext.model === this.context.model) {
                    return;
                }

                var _nextContext$actions = nextContext.actions,
                    unregister = _nextContext$actions.unregister,
                    register = _nextContext$actions.register;
