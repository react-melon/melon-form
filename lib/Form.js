(function (global, factory) {
    if (typeof define === "function" && define.amd) {
        define(['exports', 'react', 'redux', './createActionCreators', 'react-redux', './selectors', 'shallow-equal/objects'], factory);
    } else if (typeof exports !== "undefined") {
        factory(exports, require('react'), require('redux'), require('./createActionCreators'), require('react-redux'), require('./selectors'), require('shallow-equal/objects'));
    } else {
        var mod = {
            exports: {}
        };
        factory(mod.exports, global.react, global.redux, global.createActionCreators, global.reactRedux, global.selectors, global.objects);
        global.Form = mod.exports;
    }
})(this, function (exports, _react, _redux, _createActionCreators, _reactRedux, _selectors, _objects) {
    'use strict';
    ...
    var Form = function (_Component) {
        ...
        Form.prototype.componentWillReceiveProps = function componentWillReceiveProps(nextProps) {
            ...
            if ((0, _objects2['default'])(this.props, nextProps)) {
                return;
            }
